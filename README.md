...
- Collaborator on [SAFE-MCP](https://github.com/SAFE-MCP/safe-mcp) — security framework documenting 80+ attack techniques for Model Context Protocol
...
- [cursor-workshop](https://github.com/bishnubista/cursor-workshop) — materials and exercises for AI-assisted coding workshops
...
- 🎟️ [Luma Events](https://luma.com/user/bbista) — AI workshops & community events
